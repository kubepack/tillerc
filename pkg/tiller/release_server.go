...
func (s *ReleaseServer) performUpdate(originalRelease, updatedRelease *hapi.Release) error {
	...
	if err := s.performKubeUpdate(originalRelease, updatedRelease, updatedRelease.Spec.Recreate, updatedRelease.Spec.Timeout, updatedRelease.Spec.Wait); err != nil {
...
func (s *ReleaseServer) performKubeUpdate(currentRelease, targetRelease *hapi.Release, recreate bool, timeout int64, shouldwait bool) error {
...
func (s *ReleaseServer) performRelease(rel *hapi.Release) error {
	...
	default:
		...
		//os.Exit(1)
		if err := s.env.KubeClient.Create(rel.Namespace, b, rel.Spec.Timeout, rel.Spec.Wait); err != nil {
